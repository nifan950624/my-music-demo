    ...
    <div class="tab-content noCollapse">
      <div class="page-1 active">
        ...
        <section class="art">
          ...
          <div class="copyright">网易公司版权所有©1997-2017 杭州乐读科技有限公司运营</div>
        </section>
      </div>
    </div>
  </div>
...
section.playlists > .songs > li {
  width: 32.8%;
  margin: 8px 0;
}

section.playlists > .songs > li p {
  display: -webkit-box;
...
section.art {
  padding-top: 38px;
  padding-bottom: 18px;
  background: transparent url(//i.loli.net/2017/08/25/599f862b9c98d.png)
    no-repeat center;
